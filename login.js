...
(function applyLoginLocale() {
    ...
    const copy = {
        en: {
            ...
            termsHtml: 'Agree to <a href="terms.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">Terms</a>, <a href="privacy.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">Privacy</a>, <a href="consent.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">Consent</a> &amp; <a href="cookies.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">Cookies</a>',
        ...
        ru: {
            ...
            termsHtml: 'Принимаю <a href="terms.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">Условия</a>, <a href="privacy.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">Политику</a>, <a href="consent.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">Согласие</a> и <a href="cookies.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">Cookies</a>',
