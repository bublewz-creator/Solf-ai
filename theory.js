...
(function () {
    ...
    function getD7Voicings(tonic, mode) {
        ...
        // Регистр держим компактным (в основном окт.4–5, на стане), удвоение примы —
        // ВИДИМОЕ через октаву (f/4 + f/5), как в учебнике.
        const forms = [
            {
                label: 'D7', target: 'T3',
                chord: [[5, 7], [9, 14], [11, 17], [14, 23]],          // C4  G4  Bb4 E5
                res:   [[8, 12], [10, 12 + S3], [15, 24]]              // F4  Ab4 F5     (утроенная прима + терция, без квинты)
            },
            {
            ...
            },
            {
                ...
                chord: [[9, 14], [11, 17], [12, 19], [14, 23]],        // G4  Bb4 C5  E5
                res:   [[8, 12], [10, 12 + S3], [12, 19], [15, 24]]    // F4  Ab4 C5  F5  (полная, удвоенная прима)
            },
            {
                label: 'D2', target: 'T6',
