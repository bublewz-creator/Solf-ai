        ...
        const forms = [
            {
                ...
                res:   [[1, 0], [8, 12], [10, 12 + S3]]                // I(низ)  I  III  — утроенная прима без квинты
            },
            {
                label: 'D6/5', target: 'T53',
                chord: [[7, 11], [9, 14], [11, 17], [12, 19]],         // VII# II  IV  V
                res:   [[8, 12], [10, 12 + S3], [12, 19]]              // I  III  V — удвоенная прима (тесно)
            },
            {
            ...
            },
            {
                ...
                res:   [[10, 12 + S3], [12, 19], [15, 24]]             // III(бас)  V  I — секстаккорд, удвоенная прима
            }
        ];
