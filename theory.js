...
(function () {
    ...
    function wantsBothTritoneForms(t) {
        return /натуральн[а-яё]*\s*(?:и|,|\+)\s*гармоническ|гармоническ[а-яё]*\s*(?:и|,|\+)\s*натуральн|natural\s+and\s+harmonic/i.test(t);
    }
...
«Натуральные и гармонические тритоны» → ОБА набора (4+4 созвучия), barlines:"manual".
D7 + разрешение → формы D7 с разрешениями в тонику.
