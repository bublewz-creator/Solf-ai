...
(function () {
    ...
    function getD7Voicings(tonic, mode) {
        ...
        // Разрешения (по правилам страницы-эталона):
        //   D7 → T3   : утроенная прима, БЕЗ квинты (бас V→I вниз);
        //   D6/5 → T53: удвоенная прима (тесно);
        //   D4/3 → T53: развёрнутое, прима снизу И сверху (через октаву);
        //   D2 → T6   : секстаккорд, удвоенная прима.
        ...
        const forms = [
            {
                ...
                res:   [[8, 12], [8, 12], [10, 12 + S3], [15, 24]]         // I I(унисон) III I(окт.) — УТРОЕННАЯ прима без квинты, компактно на стане
            },
            {
